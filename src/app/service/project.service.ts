    ...
    switch (id) {
      ...
      case '2':
        return {
          ...
          name: 'Belmonte',
          thumbnailUrl:
            'assets/images/2-belmonte/krafna-architects-belmonte.jpg',
          leftImagesUrl: [''],
          rightImagesUrl: [''],
          description: 'Porto',
        };
      case '3':
        return {
          ...
          name: 'Botschaft',
          thumbnailUrl:
            'assets/images/3-botschaft/krafna-architects-botschaft.jpg',
          leftImagesUrl: [''],
          rightImagesUrl: [''],
          description: 'Porto',
        };
      ...
      case '5':
        return {
          ...
          name: 'Constituição',
          thumbnailUrl:
            'assets/images/5-constituicao/krafna-architects-constituicao.jpg',
          leftImagesUrl: [''],
          rightImagesUrl: [''],
          description: 'Porto',
        };
      ...
      case '9':
        return {
          ...
          name: 'Casa Nova',
          thumbnailUrl:
            'assets/images/9-casa-nova/krafna-architects-casa-nova.jpg',
          leftImagesUrl: [''],
          rightImagesUrl: [''],
          description: 'Oliveira de Azemeis',
        };
